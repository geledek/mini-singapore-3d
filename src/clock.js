...
// NOTE (Elon fix): Unified holiday logic. singapore-holidays.js is the single source of truth.
// Extend that file annually for lunar holidays. Covers 2025-2030.
...
export default class {
    ...
    getCalendar() {
        ...
        // ELON FIX: Use the proper holiday module (single source of truth)
        if (dayOfWeek === 0 || SingaporeHolidays.isHoliday(date)) {
            return 'Holiday';
        }
        if (dayOfWeek === 6) {
            return 'Saturday';
